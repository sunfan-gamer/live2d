...
public class GameSweet : MonoBehaviour {
    ...
    private GameManager_sweet.SweetsType type;
    public GameManager_sweet.SweetsType Type
    {
        get
        {
            return type;
    ...
    [HideInInspector]
    public GameManager_sweet gameManager;
    ...
    public void Init(int _x,int _y,GameManager_sweet _gameManager,GameManager_sweet.SweetsType _type)
    {
        x = _x;
        y = _y;
