...
public class GameManager_sweet : MonoBehaviour
{
    /// <summary>
    /// 甜品相关的成员变量
    /// </summary>
    ...
    //单例
    private static GameManager_sweet _instance;
    public static GameManager_sweet Instance
    {
        get
        {
            return _instance;
